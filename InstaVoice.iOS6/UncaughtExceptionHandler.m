...
- (void)handleException:(NSException *)exception
{
   ...
   // NSArray *str=[[exception userInfo] objectForKey:UncaughtExceptionHandlerAddressesKey];
    NSString *str=[NSString stringWithFormat:@"%@,%@",[exception reason],[[exception userInfo] objectForKey:UncaughtExceptionHandlerAddressesKey]];
    NSLog(@"str %@",str);
    [crashDiscription appendString:str];
